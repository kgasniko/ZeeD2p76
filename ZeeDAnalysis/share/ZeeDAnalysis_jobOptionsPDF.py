...
try:
    checkVariable("ZeeDPDFName", ZeeDPDFName)
except NameError:
    ZeeDPDFName=""
if ZeeDPDFName=="":
    ZeeDAnalysisSvc.ApplyPDFReweighting=False
else: 
    ZeeDAnalysisSvc.ApplyPDFReweighting=True
    ZeeDAnalysisSvc.PDFFileName=ZeeDPDFName

try:
    checkVariable("ZeeDPDFSet", ZeeDPDFSet)
except NameError:
    ZeeDPDFSet=0

ZeeDAnalysisSvc.PDFSetNumber= ZeeDPDFSet
...
#ZeeDAnalysisSvc.ManualGRLFilename =  '../share/GRL/ilumicalc_merged_grl_219257.56-219364.196.xml'
#ZeeDAnalysisSvc.ManualGRLFilename =  'ilumicalc_merged_grl_219228.327-219364.196.xml'
