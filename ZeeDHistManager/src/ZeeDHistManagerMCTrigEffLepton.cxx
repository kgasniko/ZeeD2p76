...
{     
  ...
  const TString ptBins=ZeeDMisc::FindFile("Binning/ElecPt.txt");
    ...
    AddTH1D("LepEtaNoTrigMatch", etaBins, "P_{t} [MeV]");
     AddTH1D("LepEtaNoTrigMatchMinus", etaBins, "P_{t} [MeV]");
      AddTH1D("LepEtaNoTrigMatchPlus", etaBins, "P_{t} [MeV]");
 AddTH1D("LepEtaTrigMatch", etaBins, "P_{t} [MeV]");
    AddTH1D("LepEtaTrigMatchMinus", etaBins, "P_{t} [MeV]");
    AddTH1D("LepEtaTrigMatchPlus", etaBins, "P_{t} [MeV]");
