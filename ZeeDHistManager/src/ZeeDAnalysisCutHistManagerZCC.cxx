...
/*
    ...
    CutNames.push_back("ElecOppositeZ");
...
*/
    ...
    */
    ...
    this->AddMask("DEFAULT-ElecOppositeZ", new ZeeDHistManagerBoson(this->getName() + "/" + "BosonSC"));
    this->AddMask("DEFAULT-ElecOppositeZ", new ZeeDHistManagerElectron(this->getName() + "/" + "ElectronSC"));
    this->AddMask("DEFAULT-ElecOppositeZ", new ZeeDHistManagerEvent(this->getName() + "/" + "EventSC"));
    this->AddMask("DEFAULT-ElecOppositeZ-IsEMMediumPPBothElecZ", new ZeeDHistManagerBoson(this->getName() + "/" + "BosonBG"));
    this->AddMask("DEFAULT-ElecOppositeZ-IsEMMediumPPBothElecZ", new ZeeDHistManagerElectron(this->getName() + "/" + "ElectronBG"));
    this->AddMask("DEFAULT-ElecOppositeZ-IsEMMediumPPBothElecZ", new ZeeDHistManagerEvent(this->getName() + "/" + "EventBG"));
    }
